...
export default function Footer() {
  return (
    <footer className="py-24 border-t bg-cream">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-16">
        <div className="space-y-8">
          <Link href="/" className="text-3xl font-black tracking-tighter text-olive-600">
          ...
          <div className="flex gap-4">
             ...
             <div className="w-10 h-10 rounded-xl bg-slate-200 hover:bg-olive-600 hover:text-white transition-all cursor-pointer flex items-center justify-center font-black italic">f</div>
             <div className="w-10 h-10 rounded-xl bg-slate-200 hover:bg-olive-600 hover:text-white transition-all cursor-pointer flex items-center justify-center font-black italic">ig</div>
             <div className="w-10 h-10 rounded-xl bg-slate-200 hover:bg-olive-600 hover:text-white transition-all cursor-pointer flex items-center justify-center font-black italic">x</div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button className="h-14 rounded-2xl bg-olive-700 hover:bg-olive-600 text-white font-black tracking-widest uppercase transition-all shadow-xl shadow-slate-100">ABONE OL</Button>
          </div>
        </div>
      </div>
