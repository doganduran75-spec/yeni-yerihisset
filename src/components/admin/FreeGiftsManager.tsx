...
export default function FreeGiftsManager() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Belirli kategoriler sepete eklendiğinde otomatik ücretsiz ürün verilir.
        </p>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center border-2 border-dashed rounded-xl border-slate-200 text-slate-400">
          Henüz ücretsiz ürün kuralı eklenmemiş.
        </div>
      ) : (
                  ...
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        {rule.selection_group && (
                          <Badge variant="outline" className="text-[10px] text-olive-700 border-olive-200">
                            Grup: {rule.selection_group}
                          </Badge>
                        )}
                      </div>
