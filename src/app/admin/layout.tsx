...
import { LayoutDashboard, Settings, Users, ExternalLink, BookOpen, Handshake, MessagesSquare, Link2, Ticket, BellRing, FileEdit, Send, Boxes, Inbox, BarChart3 } from "lucide-react";
          ...
          <SidebarGroup className="py-1">
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    render={<Link href="/admin/analytics"><BarChart3 size={18} className="mr-2" /> İstatistikler</Link>}
                  />
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton
          ...
          <SidebarGroup className="py-1">
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    render={<Link href="/admin/feedback"><Inbox size={18} className="mr-2" /> Talep & Geri Bildirim</Link>}
                  />
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton
